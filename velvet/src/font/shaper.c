...
vl_result_t vl_font_shaper_add_font(vl_font_shaper_t *shaper, vl_font_t *font) {
    if (!shaper || !font || !shaper->context || !shaper->context->font_shaper_add_font) return VL_ERROR;
